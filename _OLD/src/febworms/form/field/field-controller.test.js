describe('febworms-field-controller', function() {

  var febwormsUtils, $scope, $controller;

  beforeEach(function() {

    module('febworms');

    inject(function(_febwormsUtils_, _$rootScope_, _$controller_) {
  ...
  it('should construct controller', function() {
    ...
    var result = $controller('febwormsFieldController', {
      $scope: $scope,
      febwormsUtils: febwormsUtils
    });
  ...
  describe('initForm', function() {
    ...
    it('should use form from form controller', function() {
      ...
      var controller = $controller('febwormsFieldController', {
        $scope: $scope,
        febwormsUtils: febwormsUtils
      });
  ...
  describe('initField', function() {
    ...
    it('should create a unique id for the field', function() {
      ...
      spyOn(febwormsUtils, 'getUnique').andCallFake(function() {
        return 666;
      });
      ...
      expect(febwormsUtils.getUnique).toHaveBeenCalled();
      expect(result).toBeDefined();
  ...
  describe('setFieldState', function() {
    ...
    it('should set the field state', function() {
      ...
      var controller = $controller('febwormsFieldController', { $scope: $scope, febwormsUtils: febwormsUtils });
